...
meis_municipio = pd.read_csv(r'Html\P_P_treino\flaskr\data\meis_municipios.csv')
meis_estado = pd.read_csv(r'Html\P_P_treino\flaskr\data\meis_estados.csv')
meis_regiao = pd.read_csv(r'Html\P_P_treino\flaskr\data\meis_regiao.csv')
idh_municipio = pd.read_csv(r'Html\P_P_treino\flaskr\data\idh_municipio.csv')
idh_estado = pd.read_csv(r'Html\P_P_treino\flaskr\data\idh_estado.csv')
